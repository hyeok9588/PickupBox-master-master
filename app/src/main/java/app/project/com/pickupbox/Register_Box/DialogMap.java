            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                if (MarkerPoints.size()==1){
                 ...
                 /*   CircleOptions circleOptions = new CircleOptions();
                    circleOptions .center(new LatLng(currentMarker.getPosition().latitude,currentMarker.getPosition().longitude));
                    circleOptions.radius(500); //500m
                    ...
                    Toast.makeText(getApplicationContext(),"도착 위치가 변경 설정되었습니다.",Toast.LENGTH_SHORT).show();
                    btnOkay.setVisibility(View.VISIBLE);
