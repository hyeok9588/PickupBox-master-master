...
public class Frag4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (LOG_INOUT == 1){
            if (CheckFile() == true){
                ...
                StorageReference imageRef = storageRef.child("images/"+userName+"/"+userName+"_Dstart.png");
    ...
    private boolean CheckFile(){
        ...
        imageRef.child(userName).child(userName+"_Dstart.png")
        ...
        if (filePath != null) {
           ...
           /* SimpleDateFormat formatter = new SimpleDateFormat("yyMMdd_hhmm_");
            ...
            StorageReference storageRef = storage.getReferenceFromUrl("gs://boxstorage-8f972.appspot.com")
                    .child("images/" + userName+"/"+userName+"_Dstart.png");
            /*images/admin/admin_start.png*/
