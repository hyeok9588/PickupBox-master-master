...
public class FragDialog_AddMap extends BottomSheetDialogFragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private String Dis, Dur, newDur, DestName; //소요시간 소요거리
    ...
    private ArrayList<LocationExample> boxList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_frag_dialog__add_map, container, false);
        ...
        tvPickResult = (TextView)v.findViewById(R.id.tvPickResult);
...
/*        DBConnTask dbConnTask = new DBConnTask();
        ...
        btnOkay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent someIntent = new Intent("map_result");

                String myLati = Double.toString(currentMarker.getPosition().latitude);
                String myLongi = Double.toString(currentMarker.getPosition().longitude);
                String destLati = DestLat.toString();
                String destLongi = DestLong.toString();
                String destination = DestName;
                String duration = newDur;
                String distance = Dis;

                someIntent.putExtra("myLati",myLati);
                someIntent.putExtra("myLongi",myLongi);
                someIntent.putExtra("destLati",destLati);
                someIntent.putExtra("destLongi",destLongi);
                someIntent.putExtra("destination",destination);
                someIntent.putExtra("duration",duration);
                someIntent.putExtra("distance",distance);
...
*/
        dataList = getArguments().getParcelableArrayList("locationList");
