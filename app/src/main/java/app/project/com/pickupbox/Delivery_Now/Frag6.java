...
public class Frag6 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (LOG_INOUT == 1){
            if (CheckFile() == true){
                ...
                StorageReference imageRef = storageRef.child("images/"+userName+"/"+userName+"_Ddone.png");
    ...
    private boolean CheckFile(){
        ...
        imageRef.child(userName).child(userName+"_Ddone.png")
    ...
    private void uploadFile() {
        if (filePath != null) {
            ...
            StorageReference storageRef = storage.getReferenceFromUrl("gs://boxstorage-8f972.appspot.com")
                    .child("images/" + userName+"/"+userName+"_Ddone.png");
